data: extend({
    ...
    {
      {
        filename = "__Stone-Processor__/graphics/entity/stone-washer/stone-washer.png",
        width = 337,
        height = 255,
        frame_count = 1,
      ...
      {
        filename = "__Stone-Processor__/graphics/entity/stone-washer/stone-washer-shadow.png",
        width = 337,
        height = 213,
        frame_count = 1,
    ...
    {
      {
        ...
        animation =
        {
          filename = "__Stone-Processor__/graphics/entity/stone-washer/stone-washer-fire.png",
          line_length = 10,
          width = 20,
          height = 40,
          frame_count = 60,
